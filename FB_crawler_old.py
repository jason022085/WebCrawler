...
Links = FindLinks(url='https://www.facebook.com/groups/108AES/', n=0)
login(driver)
# sys.exit()
# %%
# 抓下來所有留言
...
Links = FindLinks(url='https://www.facebook.com/groups/108AES/', n=100)
for i in Links:
